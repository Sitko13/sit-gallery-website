    ...
    <div class="container mx-auto text-center px-4">
      ...
      <div class="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-12">
        ...
        <div class="text-center">
          <a href="mailto:peter@sitgallery.com" class="inline-block p-4 bg-white rounded-full shadow-md mb-2">
            <svg class="w-8 h-8 text-brand-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
          </a>
          <h3 class="font-semibold text-brand-dark">Email</h3>
          <a href="mailto:peter@sitgallery.com" class="text-gray-600 hover:text-brand-dark">peter@sitgallery.com</a>
        </div>
